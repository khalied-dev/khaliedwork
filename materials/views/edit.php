...
<div id="wrapper">
    <div class="content">
        <div class="row">
            ...
            echo form_open(/* $this->uri->uri_string()*/admin_url('materials/edit/' . $material->id), ['id' => 'materials_form', 'onsubmit' => 'return false;']); ?>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content tw-mt-3">
                            ...
                            <div class="col-md-12">
                                ...
                                echo render_input('item_code', 'item code', $value); 
                                ?>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                echo render_input('item_name', 'item name', $value); 
                                ?>
                            </div>
                            ...
                            <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        echo render_textarea('remarks', '', $remarks, [], [], '', 'tinymce');
                                        ?>
                                    </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                echo render_input('partner', 'Partner', $value); 
                                ?>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                echo render_input('partner_item_code', 'Partner\' item code', $value); 
                                ?>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                echo render_input('partner_item_name', 'Partner\' item name', $value); 
                                ?>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                echo render_input('category_id', 'Category ID', $value); 
                                ?>
                            </div>
                            ...
                            <div class="col-md-6">    
                                ...
                                echo render_input('field_id', 'Field id', $value); 
                                ?>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                echo render_input('purchase_price', 'Purchase price', $value); 
                                ?>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                echo render_input('sell_price', 'Sell price', $value); 
                                ?>
                            </div>
...
<?php 
//echo $material_metadata[0]['meta_field'];
//exit(0);

$sizeof_material_metadata_recs = sizeof($material_metadata);
//form_hidden('sizeof_material_metadata_recs' , $sizeof_material_metadata_recs); // Would produce: <input type="hidden" name="username" value="johndoe" /> 
?>
...
?>
                    <div class="tab-content tw-mt-3" id="metablock_<?php echo $i+1; ?>">
                            ...
                            <?php 
                            $value = $material_metadata[$i]['id'];
                            //form_hidden('id_'.($i+1) , $value); // Would produce: <input type="hidden" name="username" value="johndoe" />
                            ?>

<input type="hidden" name="id_<?php echo ($i+1); ?>" value="<?= $value ?>" />
<input type="hidden" name="isnew_<?php echo ($i+1); ?>" value="0" />
<input type="hidden" id="isdeleted_<?php echo ($i+1); ?>" name="isdeleted_<?php echo ($i+1); ?>" value="0" />
<input type='hidden' id='isjustadded_<?php echo ($i+1); ?>' name='isjustadded_<?php echo ($i+1); ?>' value='0' />
<input type='hidden' id='is_to_take_in_mind_<?php echo ($i+1); ?>' name='is_to_take_in_mind_<?php echo ($i+1); ?>' value='1' />

                            <div class="col-md-6">
                                <br>
                                <?php 
                                $value = isset($material_metadata[$i]) ? $material_metadata[$i]['meta_field'] : ''; 
                                echo render_input('meta_field_'.($i+1), 'Name', $value); 
                                ?>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                echo render_input('meta_value_'.($i+1), 'Value', $value); 
                                ?>
                            </div>
                            ...
                            <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        echo render_textarea('remarks_'.($i+1), '', $remarks, [], [], '', 'tinymce');
                                        ?>
                                    </div>
                            </div>
                                ...
                                <div class="panel-footer text-right">
                                    ...
                                    <button id="deleter" onclick="to_decider(<?php echo $i+1; ?>)" type="submit" data-form="#costcenter_form" class="btn btn-primary"
                                        autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>">
                                        <?php echo _l('delete'); ?>
                                    </button>
                                </div>
...
//if($i == ($sizeof_material_metadata_recs-1)){}
