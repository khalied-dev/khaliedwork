...
<div id="wrapper">
    <div class="content">
        <div class="row">
            ...
            echo form_open(/* $this->uri->uri_string()*/admin_url('materials/edit_metafields_groups/'.$metafields_groups->id), ['id' => 'materials_form']); ?>
...
<input type="hidden" name="id" value="<?php echo $metafields_groups->id ?>" >

                            <div class="col-md-12">
                                <?php 
                                $value = isset($metafields_groups) ? $metafields_groups->group_name : ''; 
                                echo render_input('group_name', 'Group Name', $value); 
                                ?>
                            </div>
                            ...
                            <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        $group_details = isset($metafields_groups) ? $metafields_groups->group_details : '';
                                        echo render_textarea('group_details', '', $group_details, [], [], '', 'tinymce');
                                        ?>
                                    </div>
                            </div>
                            </div>
