...
$partner_item_name_arr = array();
$partner_item_code_arr = array();
$firstTime = true;
...
if($firstTime){
array_push($partner_item_name_arr, $aRow['partner_item_name']);
array_push($partner_item_code_arr, $aRow['partner_item_code']);
}



if(!$firstTime &&   in_array($aRow['partner_item_name'], $partner_item_name_arr)    &&   in_array($aRow['partner_item_code'], $partner_item_code_arr)){}
