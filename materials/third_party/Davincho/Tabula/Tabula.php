...
class Tabula
{
     ...
     * Path to jar file
     */
    private $jarArchive = __DIR__.'/../../../libraries/tabula-1.0.1-jar-with-dependencies.jar';
    // private $jarArchive = __DIR__ . '/../../../lib/tabula.jar';
    ...
    public function parse($parameters = [], $file = null, $utf8Encode = true)
    {
        ...
        '-t', '-l', '-p', 'all', '-g','-f','CSV','-o',$inputFile.'.csv'];
