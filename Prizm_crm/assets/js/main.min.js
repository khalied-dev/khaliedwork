...
this.api()
          ...
          .every(function () {
              ...
              input.name=`${title}`;
              input.type='search';
              input.classList.add("form-control","input-sm","dtable-search")
              input.setAttribute("aria-controls","table-advanceleads")

           

              let breaker= document.createElement('br')
              column.header().appendChild(breaker)
              column.header().appendChild(input);
              let elem = document.createElement('i')
              elem.setAttribute("id",`${title}`)
              elem.classList.add("fa","fa-search","dtable-search-icon")
              elem.style.color= '#d4dbe8'
              column.header().appendChild(elem)
              console.log(column)
...
function edit_note(e) {
    ...
    "" !== t && ($.post(admin_url + "misc/edit_note/" + e, {
        ...
        !0 !== (a = JSON.parse(a)).success && "true" != a.success || (alert_float("success", a.message),
        $("body").find('[data-note-description="' + e + '"]').html(nl2br(t)))
    }
    )),
    toggle_edit_note(e))
}
...
function init_proposal_editor() {
    ...
    e.length > 0 && (t.templates = e,
    t.plugins[3] = "template " + t.plugins[3],
    t.contextmenu = t.contextmenu.replace("inserttable", "inserttable template")),
    tinymce.init(t)
}
...
function init_table_staff_projects(e) {
    ...
    if (0 !== $("body").find(".table-staff-projects").length) {
        ...
        initDataTable(".table-staff-projects", admin_url + "projects/staff_projects", "undefined", "undefined", t, [2, "asc"])
                ...
                * @since   2023-SEP-8
                */ 
function init_table_followed_tasks(e) {
    if (void 0 === e && $("body").hasClass("dashboard"))
        return !1;
    if (0 !== $("body").find(".table-followed_tasks").length) {
        var s = $("._filters _hidden_inputs.hidden input");
                $.each(s, (function() {
            $('._filters input[name="my_created_tasks"]').val("")
        }
        ))
        var t = {}
          , a = $("._hidden_inputs._filters.followed_tasks_filter input");
        $.each(a, (function() {
            t[$(this).attr("name")] = '[name="my_follower_tasks"]'
        }
        )),
        initDataTable(".table-followed_tasks", admin_url + "tasks/table", "undefined", "undefined", t, [2, "asc"])
    }
}

function init_table_created_tasks(e) {
    if (void 0 === e && $("body").hasClass("dashboard"))
        return !1;
    if (0 !== $("body").find(".table-created_tasks").length) {
        var s = $("._filters _hidden_inputs.hidden input");
        $.each(s, (function() {
            $('._filters input[name="my_follower_tasks"]').val("")
        }
        ))
        var t = {}
          , a = $("._filters._hidden_inputs.hidden.created_tasks_filter input");
        $.each(a, (function() {
            t[$(this).attr("name")] = '[name="my_created_tasks"]'
        }
        )),
        initDataTable(".table-created_tasks", admin_url + "tasks/table", "undefined", "undefined", t, [2, "asc"])
    }
}
...
function recalculate_checklist_items_progress() {
    ...
    0 == t ? ($("body").find(".chk-heading").remove(),
    $("#task-no-checklist-items").removeClass("hide")) : $("#task-no-checklist-items").addClass("hide"),
    !(t > 2))
...
*/
    ...
    $("body").on("click", ".task-single-add-timesheet", (function(e) {
        ...
        if ("" !== t && "" !== a || "" !== i) {
            ...
            $.post(admin_url + "tasks/log_time", n).done((function(e) {
                !0 === (e = JSON.parse(e)).success || "true" == e.success ? (init_task_modal(n.timesheet_task_id),
                alert_float("success", e.message),
                setTimeout((function() {
                    reload_tasks_tables()
                }
    ...
    if ((table_tasks = $(".table-tasks")).length) {
        var v, b = {
            /**   
* Start <Tasks Table Column Search>.   
*   
* @author  @EhabIdris  @prizm 
* @version 1.0   
* @since   2023-10-09    
...
name:"[name='Name']",
        ...
        asignee:"[name='Assigned to']"
/**   
* End <Tasks Table Column Search>.  
*/
         };
        ...
        requestGetJSON("invoices/client_change_data/" + e + "/" + (n = void 0 === n ? "" : n)).done((function(e) {
            ...
            var o = e.client_currency
              , l = $("body").find('.accounting-template select[name="currency"]');
               var currency_symbol = $('body').find('#currency_symbol');
            (!e.client_currency_symbol)?currency_symbol.html('AED'):currency_symbol.html(e.client_currency_symbol);
