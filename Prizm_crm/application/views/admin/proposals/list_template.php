    ...
    <div class="tw-mb-2 sm:tw-mb-4">
        <div class="_buttons">
            <?php if (has_permission('proposals', '', 'create')) { ?>
                <a href="<?php echo admin_url('proposals/proposal'); ?>" class="btn btn-primary pull-left display-block new-proposal-btn">
                    <i class="fa-regular fa-plus tw-mr-1"></i>
                    <?php echo _l('new_proposal'); ?>
                </a>
            <?php } ?>
            <a href="<?php echo admin_url('proposals/pipeline/' . $switch_pipeline); ?>" class="btn btn-default mleft5 pull-left switch-pipeline hidden-xs" data-toggle="tooltip" data-placement="top" data-title="<?php echo _l('switch_to_pipeline'); ?>">
                        ...
                        <div class="tw-grid tw-grid-cols-2 md:tw-grid-cols-3 lg:tw-grid-cols-6 tw-gap-2">
                            <?php foreach ($proposal_statuses as $status) : ?>
                                <div class="md:tw-border-r md:tw-border-solid md:tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center">
                                    <a href="" onclick="dt_custom_view('proposals_<?php echo $status; ?>','.table-proposals','proposals_<?php echo $status; ?>'); return false;">
                                        <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                            <?= get_proposal_count_by_status($status); ?></span>
                                        <span class="text-dark tw-truncate sm:tw-text-clip"><?php echo format_proposal_status($status, '', false); ?></span>
                                    </a>
                                </div>
                            <?php endforeach; ?>
                            <!-- <div class="md:tw-border-r md:tw-border-solid md:tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center">
                                <a href="">
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                        8</span>
                                    <span class="text-success tw-truncate sm:tw-text-clip">Sent</span>
                                </a>
                            </div>
                            <div class="md:tw-border-r md:tw-border-solid md:tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center">
                                <a href="">
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                        16</span>
                                    <span class="text-danger tw-truncate sm:tw-text-clip">Open</span>
                                </a>
                            </div>
                            <div class="md:tw-border-r md:tw-border-solid md:tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center">
                                <a href="">
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                        18 </span>
                                    <span class="text-info tw-truncate sm:tw-text-clip">Revised</span>
                                </a>
                            </div>
                            <div class="md:tw-border-r md:tw-border-solid md:tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center">
                                <a href="">
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                        0 </span>
                                    <span class="text-danger tw-truncate sm:tw-text-clip">Declined</span>
                                </a>
                            </div>
                            <div class="md:tw-border-r md:tw-border-solid md:tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center">
                                <a href="">
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                        0 </span>
                                    <span class="text-danger tw-truncate sm:tw-text-clip">Accepted</span>
                                </a>
                            </div>
                            <div class="tw-flex tw-items-center md:tw-border-r md:tw-border-solid tw-flex-1 md:tw-border-neutral-300 lg:tw-border-r-0">
                                <a href="">
                                    <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg">
                                        0 </span>
                                    <span class="text-muted tw-truncate" data-toggle="tooltip" data-title="Contacts Logged In Today">
                                        <span>
                                            Contacts Logged In Today </span>
                                    </span>
                                </a>
                            </div> -->
                        </div>
