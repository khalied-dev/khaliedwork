                        ...
                        <div class="tab-content tw-mt-5">
                            <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                                ...
                                <div class="form-group">
                                    <label for="profile_image" class="profile-image"><?php echo _l('staff_edit_employee_code'); ?></label>
                                    <input type="text" value="<?php if (isset($member)) {
                                                                    echo $member->employee_code;
                                                                } ?>" name="employee_code" class="form-control" id="employee_code">
                                </div>
                                ...
                                <?php } ?>
                                <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip" data-title="<?php echo _l('staff_email_signature_help'); ?>"></i>
                            ...
                            <table class="table dt-table">
                                ...
                                <tbody>
                                    ...
                                    foreach ($timesheets as $t) { ?>
                                        <tr>
                                            <td><a href="#" onclick="init_task_modal(<?php echo $t['task_id']; ?>); return false;"><?php echo $t['name']; ?></a>
                                            </td>
