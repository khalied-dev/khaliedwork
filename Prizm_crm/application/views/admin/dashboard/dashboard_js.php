...
<script>
    ...
    $(function() {
        ...
        var departments_request_chart = $('#departments_request_chart');
        ...
        if (departments_request_chart.length > 0) {
            // Leads overview status
            var pieChart = new Chart(departments_request_chart, {
                type: 'pie',
                data: <?= $departments_request_chart ?>
            });
        }
