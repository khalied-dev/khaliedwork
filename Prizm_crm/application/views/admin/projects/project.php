            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="panel_s">
                        ...
                        <div class="tab-content tw-mt-3">
                            <div role="tabpanel" class="tab-pane active" id="tab_project">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group select-placeholder">
                                            <label for="projectseniormanager"><?php echo _l('project_senior_manager'); ?></label>
                                            <div class="clearfix"></div>


                                            <select name="projectseniormanager" id="projectseniormanager" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"  data-live-search="true" required>
                                            <option></option>   
                                            <?php foreach ($staff as $staffArray) { ?>
                                                    <option value="<?php echo $staffArray['staffid']; ?>" <?php if ((isset($project) && $project->projectseniormanager == $staffArray['staffid'])) {
                                                                                                                echo 'selected';
                                                                                                            } ?>><?php echo $staffArray['employee_code'] . "-" . $staffArray['firstname'] . " " . $staffArray['lastname']; ?></option>
                                                <?php } ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group select-placeholder">
                                            <label for="projectmanager"><?php echo _l('project_normal_manager'); ?></label>
                                            <div class="clearfix"></div>
                                            <select name="projectmanager" id="projectmanager" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-live-search="true" required>
                                            <option></option>   
                                            <?php foreach ($staff as $staffArray) { ?>

                                                    <option value="<?php echo $staffArray['staffid']; ?>" <?php if ((isset($project) && $project->projectmanager == $staffArray['staffid'])) {
                                                                                                                echo 'selected';
                                                                                                            } ?>><?php echo $staffArray['employee_code'] . "-" . $staffArray['firstname'] . " " . $staffArray['lastname']; ?></option>
                                                <?php } ?>
                                            </select>
                            ...
                            <div role="tabpanel" class="tab-pane" id="tab_settings">
                                <div id="project-settings-area">
                                    ...
                                    <div class="form-group select-placeholder <?php echo (isset($project) && $project->contact_notification == 2) ? '' : 'hide' ?>" id="notify_contacts_wrapper">
                                        <label for="notify_contacts" class="control-label"><span class="text-danger">*</span>
                    ...
                    <div class="panel-footer text-right">
                        <button type="submit" data-form="#project_form" class="btn btn-primary" autocomplete="off" data-loading-text="<?php echo _l('wait_text'); ?>">
                            <?php echo _l('submit'); ?>
                        </button>
                    </div>
                </div>
