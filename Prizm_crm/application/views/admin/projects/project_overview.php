         ...
         if ($value == '') {
             continue;
                            ...
                            <div class="sm:tw-col-span-1 project-overview-description tc-content">
                                <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
                                    <?php echo _l('project_senior_manager'); ?>
                                </dt>
                                <dd class="tw-mt-1 tw-space-y-5 tw-text-sm tw-text-neutral-900">
                                    <?php if (empty($Seniorprojectmanager)) { ?>
                                    <p class="text-muted tw-mb-0">
                                        <?php echo _l('no_project_senior_manager'); ?>
                                    </p>
                                    <?php } ?>
                            

                                    <a
                                        href="<?php echo admin_url(); ?>profile/<?php echo $Seniorprojectmanager[0]->staffid; ?>">
                                        <?php echo $Seniorprojectmanager[0]->employee_code." - ".$Seniorprojectmanager[0]->firstname ." " . $Seniorprojectmanager[0]->lastname ?>
                                    </a>
                            ...
                            <div class="sm:tw-col-span-1 project-overview-description tc-content">
                                <dt class="tw-text-sm tw-font-medium tw-text-neutral-500">
                                    <?php echo _l('project_normal_manager'); ?>
                                </dt>
                                <dd class="tw-mt-1 tw-space-y-5 tw-text-sm tw-text-neutral-900">
                                    <?php if (empty($projectmanager)) { ?>
                                    <p class="text-muted tw-mb-0">
                                        <?php echo _l('no_project_normal_manager'); ?>
                                    </p>
                                    <?php } ?>
                                 
                                    <a
                                        href="<?php echo admin_url(); ?>profile/<?php echo $projectmanager[0]->staffid; ?>">
                                        <?php echo $projectmanager[0]->employee_code." - ".$projectmanager[0]->firstname ." " . $projectmanager[0]->lastname ?>
                                    </a>
                                </dd>
                            </div>
