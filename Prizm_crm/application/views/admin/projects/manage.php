        ...
        <div class="row">
            <div class="col-md-12">
                <div class="_buttons tw-mb-2 sm:tw-mb-4">
                    ...
                    <a style="background-color:#1C90FF; border-color: #1C90FF; width: 200px ; margin-right: 10px; " href="<?php echo admin_url('projects/project'); ?>"
                        class="btn btn-primary pull-left display-block mright5">
                        <i class="fa-regular fa-plus tw-mr-1"></i>
                        <?php echo _l('new_project'); ?>
                    </a>
                    <?php } ?>
                    <a style="border:none" href="<?php echo admin_url('projects/gantt'); ?>" data-toggle="tooltip"
                    ...
                    <div class="btn-group pull-right mleft4 btn-with-tooltip-group _filter_data" data-toggle="tooltip"
                        ...
                        <button style="border:none" type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                ...
                <div style=" border-radius:20px; box-shadow:0 .125rem .25rem rgba(0,0,0,.075)!important" class="panel_s tw-mt-2 sm:tw-mt-4">
                    <div style="background-color:white; border-radius:20px; " class="panel-body">

                        <div class="row mbot15">
                            <div class="col-md-12">
                                <h4 style="color:#1C90FF; font-size: 24px;font-weight:bold; margin-bottom:30px" class="tw-mt-0 tw-font-semibold tw-text-lg tw-flex tw-items-center">
                                    <svg style="color:#1C90FF" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                      ...
                      echo form_hidden('project_status_' . $status['id'], $value); ?>
                                <div
                                    ...
                                    <a href="#"
                                        ...
                                        <span class="tw-font-semibold tw-mr-3 rtl:tw-ml-3 tw-text-lg" style="margin:auto; padding-bottom:10px;color:<?php echo $status['color']; ?>;
    font-size: 24px;">
                                            <?php echo total_rows(db_prefix() . 'projects', $where); ?>
                                        </span>
                                        <span style="font-weight:bold;color:<?php echo $status['color']; ?>"
