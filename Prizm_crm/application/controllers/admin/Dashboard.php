...
class Dashboard extends AdminController
{
    ...
    public function index()
    {
        ...
        /**   
     * Start task <Total purchases in dashboard> 3.0.6.   
     *   
     * @author  @Ahmed Hmed @Prizm   
     * @version 1.0   
     * @since   2023-8-2   
     */
    $data['departments_request_chart']    = json_encode($this->dashboard_model->departments_request_chart());

     /**    
        * End <Total purchases in dashboard>.  
        */
        ...
        /**   
        * Start <Total purchases in dashboard>.   
        *   
        * @author  @MustafaZaroug - @Prizm
        * @version 3.0.6 perfex  
        * @since   2023-09-20    
        */  
        //Departments total pur request 
        $this->load->model('purchase/purchase_model');
        $data['departments_total_requests'] = $this->purchase_model->pur_request_depart_sum_widget();
        //Projects total pur request 
        $this->load->model('purchase/purchase_model');
        $data['project_total_requests'] = $this->purchase_model->pur_request_project_sum_widget();
        /**    
        * End <Total purchases in dashboard>.  
        */
