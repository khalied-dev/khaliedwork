...
class Projects extends AdminController
{
    ...
    public function view($id)
    {
        if (staff_can('view', 'projects') || $this->projects_model->is_member($id)) {
            ...
            $projectseniormanager = $this->projects_model->getSeniorProjectManager($id);
            $projectmanager = $this->projects_model->getProjectManager($id);
            ...
            // start add senior project manager v3.3.0

            $data['Seniorprojectmanager']  = $projectseniormanager;
            $data['projectmanager']  = $projectmanager;

            // end add senior project manager v3.3.0
